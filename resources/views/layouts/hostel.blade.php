  ...
  <header class="main-header">
	<div class="d-flex align-items-center logo-box justify-content-start">	
		...
		<a href="{{ url('/admin/index') }}" class="logo">
		  ...
		  <div class="logo-lg">
			<h1>
			   <b><span style="color: orange;">U</span><span style="color: blue;">MANAGE</span></b>
			   <span class="dark-logo"><img src="{{ asset('assets/images/logo-letter-white.png') }}" alt="logo"></span>
			</h1>
		  </div>
		</a>	
    ...
    <section class="sidebar position-relative"> 
		  ...
		  <div class="multinav-scroll" style="height: 97%;">	
			  ...
			  <ul class="sidebar-menu" data-widget="tree">
				...
				<li class="treeview">
					<a href="#"><i data-feather="book"></i><span>Block Library</span>
						<span class="pull-right-container">
							<i class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
					<ul class="treeview-menu treeview-menu-visible" id="treeview-menu-visible">
						<li><a href="{{ route('hostel.block') }}" class="{{ (route('hostel.block') == Request::url()) ? 'active' : ''}}">Block</a></li>
                        <li><a href="{{ route('hostel.blockUnit') }}" class="{{ (route('hostel.blockUnit') == Request::url()) ? 'active' : ''}}">Block Unit</a></li>
                        <li><a href="{{ route('hostel.resident') }}" class="{{ (route('hostel.resident') == Request::url()) ? 'active' : ''}}">Resident</a></li>
					</ul>
				</li>
				<li class="treeview">
					...
					<ul class="treeview-menu treeview-menu-visible" id="treeview-menu-visible">
						...
						<li><a href="{{ route('hostel.student.debit') }}" class="{{ (route('hostel.student.debit') == Request::url()) ? 'active' : ''}}">Annoucement</a></li>
					</ul>
				</li>
				<li class="treeview">
					<a href="#"><i data-feather="file-text"></i><span>Report</span>
						<span class="pull-right-container">
							<i class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
