                    ...
                    <table id="table_dismissed" class="w-100 table display margin-top-10 w-p100 table-layout: fixed;" style="width: 100%;">
                      ...
                      <tfoot style="background-color: darkcyan">
                        <tr>
                          ...
                          <td style="text-align: center; border: 1px solid black;">
                            @php
                              $postpone = count(DB::connection('mysql2')->table('students')
                              ->join(DB::connection()->getDatabaseName() . '.tblstudent_hostel', 'students.ic', '=', 'tblstudent_hostel.student_ic')
                              ->where([
                                    ['students.status', 6]
                                    ])->get());
                          ...
                          <td style="text-align: center; border: 1px solid black;">
                            @php
                              $dismissed = count(DB::connection('mysql2')->table('students')
                              ->join(DB::connection()->getDatabaseName() . '.tblstudent_hostel', 'students.ic', '=', 'tblstudent_hostel.student_ic')
                              ->where([
                                    ['students.status', 4]
                                    //['students.campus_id', 1]
                          ...
                          @foreach ($semester as $sem)
                            @php
                              if($sem->id != 1)
                              {
                                ...
                                $holding = count(DB::connection('mysql2')->table('students')
                                ->join(DB::connection()->getDatabaseName() . '.tblstudent_hostel', 'students.ic', '=', 'tblstudent_hostel.student_ic')
